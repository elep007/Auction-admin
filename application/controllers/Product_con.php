...
class Product_con extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data["groups"] = $this->Food_model->getGroup();
...
//    public function add(){
//        $result = $this->Food_model->insert($_POST);
//        // // $data['postData'] = $_POST;
//
//        $filename ="backend/image/food/".$_POST['resid'].trim($_POST['name']).".jpg";
//        $ifp = fopen( $filename, 'wb' );
//        $data = explode( ',', $_POST['foodimg'] );
...
//
//        $result = $this->Food_model->update($id,$_POST);
//        // $data['postData'] = $_POST;
//        if($_POST['is_change'] == 1){
//            $filename ="backend/image/food/".$_POST['resid'].trim($_POST['name']).".jpg";
//            $ifp = fopen( $filename, 'wb' );
//            $data = explode( ',', $_POST['foodimg'] );
//            fwrite( $ifp, base64_decode( $data[ 1 ] ) );
...
//    }
    ...
    public function all()
    {
        ...
        $data["productInfos"] = $this->Product_model->getProductsInfo();
        $data["del_res"] = "NO";        
        $this->load->view('user/common/header', $header_data);
        $this->load->view('product/all', $data);
        $this->load->view('user/common/footer');
    ...
    public function current()
    {
        ...
        $data["productInfos"] = $this->Product_model->getCurrentAuctions();
        $data["del_res"] = "NO";
        $this->load->view('user/common/header', $header_data);
        $this->load->view('product/all', $data);
        $this->load->view('user/common/footer');
    ...
    public function delete_history(){
        ...
        echo $this->Product_model->delete_history($id);
    }
    ...
    public function detail(){
        ...
        $data["bids"]=$this->Product_model->getBids($id);
        $data["seller"]=$this->Product_model->getSeller($id);
...
//
//        $id = $_GET["id"];
//        $data["result"] = $this->Food_model->getFood($id);
//        $data["groups"] = $this->Food_model->getGroup();
//
//        $data["msg"]="";
//        $data["error"]="";
