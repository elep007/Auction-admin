  ...
  <div class="">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Foods <small>Add New Food</small></h2>                    
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
            <form class="form-horizontal" id="food-form" method="post" action="javascript:;">
              <p> </p>
              <span class="section">New Food Info</span>
              <div class="col-md-3">
                <center>
              ...
              <div class="col-md-9">
                <div class="item form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input id="food_name" class="form-control col-md-7 col-xs-12" name="name" placeholder="food" required="required" type="text">
                  </div>
                </div>
                ...
                <div class="item form-group">
                 ...
                 <div class="item form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <textarea class="form-control" rows="5" name="needdescription" id="needdescription"> </textarea>
                  </div>
                </div>                  
